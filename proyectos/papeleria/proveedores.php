...
$sql       = "SELECT empresa, telefono, correo FROM proveedores";
$resultado = $link->query($sql);
$i=1; 
?>
<section class="contenedor contenedor-proveedores">
    <h1 class="titulo subtitulo">Nuestros proveedores</h1>
...
<?php
            ...
            <tr class="carrito-tr">
                <td class="carrito-td proveedores-td" width="33%"><?=$fila['empresa']?></td>
                <td class="carrito-td proveedores-td" width="33%"><?=$fila['telefono']?></td>
                <td class="carrito-td proveedores-td" width="33%"><?=$fila['correo']?></td> 
            </tr>
<?php       } ?>
        </tbody>
    </table>
